...
<div class="form-row">
    <div class="form-group">
        ...
        <input type="date" name="tgl_pinjam" id="tgl_pinjam" required 
               value="<?php echo htmlspecialchars($data['tgl_pinjam']); ?>">
    </div>
    ...
    <div class="form-group">
        ...
        <input type="date" name="tgl_jatuhtempo" id="tgl_jatuhtempo" required 
               value="<?php echo htmlspecialchars($data['tgl_jatuhtempo']); ?>">
    </div>
</div>
...
<div class="form-row">
    <div class="form-group">
        ...
        <select name="status_pinjam" id="status_pinjam" required>
            ...
            <option value="Aktif" <?php echo $data['status_pinjam'] == 'Aktif' ? 'selected' : ''; ?>>Aktif</option>
            <option value="Lunas" <?php echo $data['status_pinjam'] == 'Lunas' ? 'selected' : ''; ?>>Lunas</option>
            <option value="Menunggak" <?php echo $data['status_pinjam'] == 'Menunggak' ? 'selected' : ''; ?>>Menunggak</option>
        </select>
    </div>
